...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>PÁGINA DE EDIÇÃO DE CONTEÚDOS DE REDAÇÃO</h1>
      <nav>
        <ol class="breadcrumb">
...
if (isset($_POST['tema'])){
    ...
    $texto = $_POST['texto'];
    $fk_redacao = addslashes($_SESSION['id_usuario_professor']['id_usuario_professor']);
    ...
    !empty($texto) && !empty($fk_redacao) ){
        ...
        if($u->msgErro == ""){
            ...
            if($u -> cadastrarredacao($nome, $email, $tema, $texto, $fk_redacao)){
